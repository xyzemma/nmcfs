...
frame1.update()
l = Label(frame1,text="nmcfs Compiler",bg="white")
l.place(x=frame1.winfo_width()/2, y=25, anchor="center")
quitbutton = ttk.Button(frame1, text="Quit", command=root.destroy)
quitbutton.place(x=frame1.winfo_width()/2+5,y=450)
compilebutton = ttk.Button(frame1, text="Compile", command=compile)
compilebutton.place(x=frame1.winfo_width()/2-80,y=450)
root.mainloop()
